...
module.exports = function (options) {
    ...
    const METADATA = Object.assign({}, helpers.DEFAULT_METADATA, options.metadata || {});
    const ngcWebpackConfig = helpers.ngcWebpackSetup(isProd, METADATA);
    const supportES2015 = helpers.supportES2015(METADATA.tsConfigPath);

    const entry = {
        polyfills: './demo-app/src/polyfills.browser.ts',
        main: './demo-app/src/main.browser.ts'
    };
    ...
    return {
        ...
        resolve: {
             ...
             */
            modules: [helpers.root('demo-app/src'), helpers.root('node_modules')],
        ...
        module: {
            ...
            rules: [
                 ...
                 */
                {
                    test: /\.html$/,
                    use: 'raw-loader',
                    exclude: [helpers.root('demo-app/src/index.html')]
                },
        ...
        plugins: [
            ...
            */
            new HtmlWebpackPlugin({
                template: 'demo-app/src/index.html',
